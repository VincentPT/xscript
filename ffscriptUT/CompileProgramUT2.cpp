...
namespace ffscriptUT
{
	...
	protected:
		...
		CompileProgram() : funcLibHelper(&scriptCompiler) {
			...
			funcLibHelper.registFunction("printFibonaci", "int", new BasicFunctionFactory<1>(EXP_UNIT_ID_USER_FUNC, FUNCTION_PRIORITY_USER_FUNCTION, "void", new FT::FunctionDelegate3<void, int>(printFibonaci), &scriptCompiler));
