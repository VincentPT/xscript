...
enum tagTokenID:unsigned int{
	//TokenID
	EXP_UNIT_OPEN_ROUND_BRACKET,
	EXP_UNIT_CLOSED_ROUND_BRACKET,
	EXP_UNIT_OPEN_CURLY_BRACKET,
	EXP_UNIT_CLOSED_CURLY_BRACKET,
	...
	EXP_UNIT_CONSTRUCTOR_COMPOSITE,
	EXP_UNIT_ASSIGMENT_COMPOSITE,
	EXP_UNIT_CREATE_OBJECT_COMPOSITE,
	EXP_UNIT_CREATE_OBJECT,
	EXP_UNIT_OPERATOR_TYPE_CAST,
	EXP_UNIT_ASSIGMENT_SEMIREF,

	EXP_UNIT_USER_FUNCTION,
};

//token id definitions
#define EXP_UNIT_ID_OPEN_CURLY_BRACKET	(EXP_UNIT_OPEN_CURLY_BRACKET|EXP_UNIT_GROUP_TOKEN)
#define EXP_UNIT_ID_CLOSED_CURLY_BRACKET	(EXP_UNIT_CLOSED_CURLY_BRACKET|EXP_UNIT_GROUP_TOKEN)
#define EXP_UNIT_ID_OPEN_ROUND_BRACKET	(EXP_UNIT_OPEN_ROUND_BRACKET|EXP_UNIT_GROUP_TOKEN)
#define EXP_UNIT_ID_CLOSED_ROUND_BRACKET	(EXP_UNIT_CLOSED_ROUND_BRACKET|EXP_UNIT_GROUP_TOKEN)
...
#define EXP_UNIT_ID_OPERATOR_TYPE_CAST			(EXP_UNIT_OPERATOR_TYPE_CAST|EXP_UNIT_GROUP_FUNCTION|EXP_UNIT_GROUP_OPERATOR)
...
#define EXP_UNIT_ID_ASSIGMENT_SEMIREF			(EXP_UNIT_ASSIGMENT_SEMIREF|EXP_UNIT_GROUP_FUNCTION|EXP_UNIT_GROUP_OPERATOR)
...
#define EXP_UNIT_ID_CONSTRUCTOR_COMPOSITE       (EXP_UNIT_CONSTRUCTOR_COMPOSITE|EXP_UNIT_GROUP_FUNCTION|EXP_UNIT_GROUP_USERFUNC)
#define EXP_UNIT_ID_ASSIGMENT_COMPOSITE         (EXP_UNIT_ASSIGMENT_COMPOSITE|EXP_UNIT_GROUP_FUNCTION|EXP_UNIT_GROUP_USERFUNC)
#define EXP_UNIT_ID_CREATE_OBJECT_COMPOSITE     (EXP_UNIT_CREATE_OBJECT_COMPOSITE|EXP_UNIT_GROUP_FUNCTION|EXP_UNIT_GROUP_USERFUNC)
#define EXP_UNIT_ID_CREATE_OBJECT               (EXP_UNIT_CREATE_OBJECT|EXP_UNIT_GROUP_FUNCTION|EXP_UNIT_GROUP_USERFUNC)
...
#define FUNCTION_PRIORITY_TYPE_CAST			(FUNCTION_ODER_LEFT_2_RIGHT|220)	/* (type) */
